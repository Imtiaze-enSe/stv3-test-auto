...
Resource          ${EXECDIR}/ressources/HELPERS/categoriesHelpers.resource
Resource          ${EXECDIR}/ressources/HELPERS/certificationsHelpers.resource
Resource          ${EXECDIR}/ressources/HELPERS/topicsHelpers.resource
